package id.co.zisal.dmt_rest.dto.response.getticket;
...
import id.co.zisal.dmt_common.constant.ApplicationConstant.Rest.DTO.Response.GetTicket;
...
public class DTOResponseGetTicket {
    ...
    public ArrayList<ArrayList<String>> tickets;
