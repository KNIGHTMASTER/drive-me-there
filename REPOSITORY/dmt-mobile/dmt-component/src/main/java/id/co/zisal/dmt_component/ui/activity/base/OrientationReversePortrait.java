 ...
 */
public class OrientationReversePortrait implements IOrientationActivity {

    private AppCompatActivity appCompatActivity;

    public OrientationReversePortrait(AppCompatActivity appCompatActivity) {
    ...
    public void setupOrientation() {
        appCompatActivity.setRequestedOrientation(ActivityInfo.SCREEN_ORIENTATION_REVERSE_PORTRAIT);
