 ...
 */
public class OrientationLandscape implements IOrientationActivity{

    private AppCompatActivity appCompatActivity;

    public OrientationLandscape(AppCompatActivity appCompatActivity) {
    ...
    public void setupOrientation() {
        ...
        Log.i(ApplicationConstant.LogTag.DMT_INFO, "Application Screen is set to ORIENTATION LANDSCAPE ");
    }
}
